...
//                "form" => $searchForm->createView()));
    ...
    /**
     * @Route("/ajouterCompte", name="ajouter_compte")
     * Ajouter un compte
     */
    ...
    /**
     * @Route("/modifierCompte/{id}", name="modifier_compte")
     * Modifier un compte
     */
    ...
    /**
     * @Route("/triNomClient", name="tri_nom_client")
     */
    ...
    /**
     * @Route("/triDateCreation", name="tri_date")
     */
    ...
    /**
     * @Route("/triEtatCompte", name="tri_etat")
     */
    ...
    /**
     * @Route("/ActiverCompte/{id}", name="activer_compte_back")
     */
...
//        ****** Partie Mailing ******
        $message = (new \Swift_Message('Activation de votre compte Bankiz'))
...
//
    ...
    /**
     * @Route("/DesactiverCompte/{id}", name="desactiver_compte_back")
     */
...
//        ****** Partie Mailing ******
        $message = (new \Swift_Message('Désactivation de votre compte Bankiz'))
            ->setFrom('testutilisateurs1@gmail.com')
            ->setTo($user->getEmailU())
            ->setBody(
                $this->renderView(
